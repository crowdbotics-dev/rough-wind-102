"""
Django settings for rough_wind_102 project.
...
ROOT_URLCONF = 'rough_wind_102.urls'
...
WSGI_APPLICATION = 'rough_wind_102.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Rough Wind Support <support@rough-wind-102.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_wind_102 API",
    "DESCRIPTION": "API documentation for rough_wind_102 App",
    "VERSION": "v1",
}
